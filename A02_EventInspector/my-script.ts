let fixedspan: HTMLElement = document.querySelector(".fixed-span"); // HTML-Element, was verändert werden soll wird ausgewählt
...
function moveSpan(_event: MouseEvent): void { // Funktion wird erstellt
...
function logInfo(_event: Event): void { // Funktion wird erstellt
