...
(function (A08_01) {
    ...
    let crc2;
    function handleLoad() {
        canvas = document.querySelector("canvas"); // Das Canvas-Element im DOM wird ausgewählt und der Variablen canvas zugewiesen.
        crc2 = canvas.getContext("2d"); // Der 2D-Zeichenkontext des Canvas wird abgerufen und der Variablen crc2 zugewiesen.
    ...
    function drawRectangle(_x, _y, _strokeColour, _fillColour) {
    ...
    function drawCircle(x, y) {
        ...
        let colorIndex = Math.floor(Math.random() * 5); //  Zahl zwischen 0 und 3
